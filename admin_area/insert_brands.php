...
if (isset($_POST['insert_brand'])){
  ...
  if($result)
  {
    echo"<script>alert('brand has been saved successfully')</script>";
  }
}
...
<div class="input-group w-10 mb-2 m-auto">
  <input type="submit" class="bg-dark text-light border-0 p-2 my-3"name="insert_brand"
   placeholder="Insert Brands">
   <!--<button class="bg-dark text-light border-0">Insert brands</button>-->
</div>
